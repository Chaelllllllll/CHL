module.exports.config = {
  ...
  role: 2,
  credits: "Chael",
  description: "Create a post in your bot account to prevent your account from being locked!",
  usePrefix: true,
  cooldowns: 5
};
...
module.exports.run = async ({ event, api }) => {
  ...
  api.httpPost('https://www.facebook.com/api/graphql/', form, (e, info) => {
    try {
      ...
      api.sendMessage("Post creation failed, please try again later.", threadID, messageID);
    }
  });

  return api.sendMessage(`AUTO POSTING INITIATED.`, threadID, messageID);
};
